...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='rmappo', choices=["rmappo", "mappo", "odis", "vomasd-single", "vomasd-hier", "vomasd-3d", "vomasd-mixed"])
    ...
    # multi-task and hierarchical processing
    parser.add_argument("--id_length", type=int, default=4, help="")
    parser.add_argument("--max_agent_id", type=int, default=15, help="")
    parser.add_argument("--skill_dim", type=int, default=5, help="")
    parser.add_argument("--skill_num", type=int, default=5, help="")
    parser.add_argument("--pretrain_steps", type=int, default=15000, help="")
    parser.add_argument("--c_step", type=int, default=5, help="")
    parser.add_argument("--pretrain_batch_size", type=int, default=32, help="")
    parser.add_argument("--beta", type=float, default=0.001, help="")
    parser.add_argument("--dropout", type=float, default=0.2, help="")
    parser.add_argument("--top_skill_num", type=int, default=5, help="")
    parser.add_argument("--rule_based", action='store_true', default=False, help="")
    parser.add_argument("--use_sparse_reward", action='store_true', default=False, help="")
    ...
    parser.add_argument("--data_collection", action='store_true', default=False, help="")
    parser.add_argument("--is_mixed", action='store_true', default=False, help="")
    parser.add_argument("--is_med", action='store_true', default=False, help="")
    parser.add_argument("--is_random", action='store_true', default=False, help="")
