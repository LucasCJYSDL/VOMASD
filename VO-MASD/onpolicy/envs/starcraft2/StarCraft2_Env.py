...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.n_actions = self.n_actions_no_attack + args.max_agent_id 
        ...
        # self.max_n_action = self.n_actions_no_attack + args.mmax_agent_id
    ...
    def get_obs_size(self):
        ...
        return [all_feats * self.stacked_frames if self.use_stacked_frames else all_feats, [n_allies, n_ally_feats-self.n_actions, self.n_actions], [n_enemies, n_enemy_feats], [1, move_feats], [1, own_feats-self.n_actions, self.n_actions, agent_id_feats, timestep_feats]]
