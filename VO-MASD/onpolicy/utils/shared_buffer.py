...
class SharedReplayBuffer(object):
    ...
    def data_insert(self, share_obs, obs, rnn_states, actions, rewards, masks, bad_masks, active_masks, available_actions):
        self.share_obs[self.step + 1] = share_obs.copy()
        self.obs[self.step + 1] = obs.copy()
    ...
    def get_data(self):
        print("current step in the buffer: ", self.step)
        return {"state": self.share_obs.copy(), "obs": self.obs.copy(), "action": self.actions.copy(), \
                "reward": self.rewards.copy(), "mask": self.masks.copy(), "avail_action": self.available_actions.copy()}
    ...
    def recurrent_generator(self, advantages, num_mini_batch, data_chunk_length):
        ...
        for indices in sampler:
            ...
            # print(share_obs_batch.shape) # (9600, 117)
